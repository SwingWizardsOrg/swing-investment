          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                  ...
                  <div className="bg-[#4472C4]/10 p-[7px] rounded-md">
                    <FormControl className="bg-[#4472C4]/40">
                      <Input
                        ...
                        {...field}
                        className=" text-slate-200 font-medium leading-10 tracking-wide"
                      />
                    </FormControl>
                  </div>
            ...
            <div className=" w-full  flex justify-center">
              <Button
                ...
                type="submit"
                className=" group-hover:bg-gradient-to-r from-blue-600/80 transition-all delay-300 duration-500"
              >
                Log In
              </Button>
            </div>
